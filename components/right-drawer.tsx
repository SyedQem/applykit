...
export function RightDrawer({
  ...
  return (
    <div className="relative">
      ...
      <aside
        className={`overflow-hidden border-l bg-white transition-[width] duration-300 ease-in-out ${open ? "w-80" : "w-0 border-l-0"}`}
      >
        ...
        <div
          className={`h-[calc(100vh-9rem)] overflow-y-auto p-3 text-sm text-slate-600 transition-all duration-200 ease-out ${
            open
